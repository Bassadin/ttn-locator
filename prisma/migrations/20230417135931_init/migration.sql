...
-- AddForeignKey
ALTER TABLE "DeviceGPSDatapoint" ADD CONSTRAINT "DeviceGPSDatapoint_deviceDevId_fkey" FOREIGN KEY ("deviceDevId") REFERENCES "Device"("deviceId") ON DELETE RESTRICT ON UPDATE CASCADE;
